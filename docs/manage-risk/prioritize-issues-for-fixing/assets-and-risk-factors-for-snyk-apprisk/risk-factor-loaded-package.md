...
{% hint style="info" %}
Navigate to the [Snyk Runtime Sensor documentation](../../../integrate-with-snyk/snyk-runtime-sensor.md) to learn more about the supported ecosystems from which the Loaded package risk factor is reported.
{% endhint %}
