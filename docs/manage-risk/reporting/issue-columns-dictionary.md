...
* **INTRODUCTION CATEGORY** - Categorizes how an issue was introduced:
  ...
  * **Other New Issue** - issues for which Snyk cannot classify their preventability. For details, see [Delineation of how risk is introduced](../enterprise-analytics/issues-analytics.md#delineation-of-how-risk-is-introduced).
